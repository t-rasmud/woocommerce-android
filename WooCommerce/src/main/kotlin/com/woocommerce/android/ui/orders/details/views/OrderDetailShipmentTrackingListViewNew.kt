...
import com.woocommerce.android.ui.orders.details.adapter.OrderDetailShipmentTrackingListAdapterNew
import kotlinx.android.synthetic.main.order_detail_shipment_tracking_list.view.*

class OrderDetailShipmentTrackingListViewNew @JvmOverloads constructor(
    ctx: Context,
    ...
    fun updateShipmentTrackingList(
        ...
        val shipmentTrackingAdapter =
            shipmentTrack_items.adapter as? OrderDetailShipmentTrackingListAdapterNew
            ?: OrderDetailShipmentTrackingListAdapterNew(onDeleteShipmentTrackingClicked)
